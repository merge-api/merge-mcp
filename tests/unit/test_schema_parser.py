...
def test_extract_request_body_properties_and_update_parameters(mock_openapi_schema):
    ...
    result = parser.extract_request_body_properties_and_update_parameters(
...
def test_extract_input_schema_and_update_parameters():
    ...
    with patch.object(
        parser, "extract_path_and_query_parameters"
        ...
        with patch.object(
            parser, "extract_request_body_properties_and_update_parameters"
        ) as mock_extract_body:
            ...
            result = parser.extract_input_schema_and_update_parameters(
                operation_schema_with_body, schema_index1
            )
...
def test_extract_input_schema_without_request_body():
    ...
    with patch.object(
        ...
        with patch.object(
            ...
            result = parser.extract_input_schema_and_update_parameters(
                operation_schema_no_body, schema_index2
            )
