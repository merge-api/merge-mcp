...
class SchemaParser:
    ...
    def extract_input_schema_and_update_parameters(
        self, operation_schema: Dict[str, Any], schema_index: SchemaIndex
    ) -> Dict[str, Any]:
        """
        ...
        body_properties = self.extract_request_body_properties_and_update_parameters(
            operation_schema, schema_index
        )
        if body_properties:
            ...
            for property, property_schema in body_properties.get(
                "properties", {}
            ).items():
            ...
            schema_index.update_schema_parameters_by_operation_id(
                operation_schema["operationId"], updated_parameters
            )
    ...
    def extract_path_and_query_parameters(
    ...
    def extract_request_body_properties_and_update_parameters(
        self, operation_schema: Dict[str, Any], schema_index: SchemaIndex
    ...
    def update_schema_with_body_properties(
        self, input_schema: Dict[str, Any], body_properties: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def convert_parameter_to_property(
        ...
        property = {parameter["name"]: property_schema}
